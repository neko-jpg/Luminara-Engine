...
impl LuaUserData for LuaPhysicsWrapper {
    fn add_methods<'lua, M: LuaUserDataMethods<'lua, Self>>(methods: &mut M) {
        methods.add_method("apply_force", |_, this, (entity_packed, x, y, z): (u64, f32, f32, f32)| {
        ...
        methods.add_method("raycast", |_, this, (ox, oy, oz, dx, dy, dz, max_dist): (f32, f32, f32, f32, f32, f32, f32)| {
             let _world = unsafe { &mut *this.0 };
