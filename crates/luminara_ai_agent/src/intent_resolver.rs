...
impl IntentResolver {
    ...
    pub fn resolve_reference(
        ...
        match reference {
            ...
            EntityReference::ById(_id) => Err("ById not fully implemented".into()),
    ...
    pub(crate) fn resolve_position(
        ...
        match position {
            ...
            RelativePosition::Above(dist) => Ok(anchor_pos + Vec3::Y * *dist),
            RelativePosition::AtOffset(offset) => Ok(anchor_pos + *offset),
