...
use luminara_math::{Mat4, Quat, Vec2, Vec3};
...
mod gltf_validation_tests {
    ...
    fn test_gltf_vertex_attributes() {
        ...
        assert!(
            !primitive.tex_coords.is_empty(),
            "Should have texture coordinates"
        );
    }
    ...
    fn test_gltf_multiple_primitives() {
        ...
        assert_eq!(
            doc.meshes[0].primitives.len(),
            2,
            "Should support multiple primitives per mesh"
        );
    }
