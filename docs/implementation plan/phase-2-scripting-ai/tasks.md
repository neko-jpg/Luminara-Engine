...
- [x] 1. Set up Phase 2 crate structure and dependencies
...
- [x] 3. Implement Lua Engine API Bridge
  ...
  - [x] 3.5 Write property test for API parameter validation
    - **Property 3: API Parameter Validation**
    - **Validates: Requirements 1.3, 14.8**
  
  - [x] 3.6 Write property test for Component API type safety
    - **Property 51: Component API Type Safety**
    - **Validates: Requirements 14.7**
  
  - [x] 3.7 Write unit tests for each API module
...
- [x] 10. Implement MCP Server foundation
  ...
  - [x] 10.3 Implement tool input validation
    - Validate against JSON schemas
    - Return structured errors for invalid input
    - Provide helpful error messages
    - _Requirements: 4.3_
  
  - [x] 10.4 Write property test for tool input validation
    - **Property 13: MCP Tool Input Validation**
    - **Validates: Requirements 4.3**

- [x] 11. Implement MCP Tools - Scene Operations
  - [x] 11.1 Implement scene.create_entity tool
  ...
  - [x] 11.2 Implement scene.modify_component tool
  ...
  - [x] 11.3 Implement scene.query_entities tool
    - Define input schema for entity queries
    - Support queries by name, tag, component
    - Return matching entities with details
    - _Requirements: 4.4_
  
  - [x] 11.4 Write property test for tool result structure
    - **Property 14: MCP Tool Result Structure**
    - **Validates: Requirements 4.5**
  
  - [x] 11.5 Write property test for tool error suggestions
    - **Property 15: MCP Tool Error Suggestions**
    - **Validates: Requirements 4.6, 8.8**

- [x] 12. Implement MCP Tools - Script Operations
  - [x] 12.1 Implement script.create tool
  ...
  - [x] 12.2 Implement script.modify tool
  ...
  - [x] 12.3 Implement debug.inspect tool
  ...
  - [x] 12.4 Implement project.scaffold tool
...
- [x] 14. Implement AI Context Engine - Semantic Index
  ...
  - [x] 14.7 Write property test for large world sampling
    - **Property 20: Large World Sampling**
    - **Validates: Requirements 5.7**

- [x] 15. Implement AI Context Engine - Schema Discovery
  - [x] 15.1 Create SchemaDiscoveryService struct
    - Set up component registry
    - Create schema taxonomy (categories)
    - Initialize usage statistics
    - _Requirements: 6.1_
  
  - [x] 15.2 Implement schema level generation
...
- [x] 16. Implement context generation integration
  ...
  - [x] 16.2 Implement generate_context method
  ...
  - [x] 16.3 Write property test for recent changes inclusion
    - **Property 18: World Digest Recent Changes Inclusion**
    - **Validates: Requirements 5.5**
  
  - [x] 16.4 Write property test for schema prioritization
    - **Property 23: Schema Token Budget Prioritization**
    - **Validates: Requirements 6.7**

- [x] 17. Checkpoint - Ensure AI context engine tests pass
  - Ensure all tests pass, ask the user if questions arise.


- [x] 18. Implement Intent Resolver
  - [x] 18.1 Create IntentResolver struct
    - Set up semantic index reference
    - Initialize world version tracking
    - _Requirements: 7.1_
  
  - [x] 18.2 Implement entity reference resolution
  ...
  - [x] 18.3 Write property test for entity reference resolution
    - **Property 24: Entity Reference Resolution**
    - **Validates: Requirements 7.1, 7.3, 7.4, 7.5**
  
  - [x] 18.4 Implement relative position resolution
...
- [x] 19. Implement Code Verification Pipeline - Static Analysis
  - [x] 19.1 Create StaticAnalyzer struct
    - Set up Lua AST parser
    - Create pattern matchers for dangerous code
    - _Requirements: 8.1_
  
  - [x] 19.2 Implement dangerous pattern detection
  ...
  - [x] 19.3 Generate fix suggestions
  ...
  - [x] 19.4 Write property test for static analysis detection
    - **Property 27: Static Code Analysis Detection**
    - **Validates: Requirements 8.1**

- [x] 20. Implement Code Verification Pipeline - Sandbox Execution
  - [x] 20.1 Create ScriptSandbox for verification
    - Create world snapshot for isolated testing
    - Configure resource limits
    - Set up monitoring
    - _Requirements: 8.2_
  
  - [x] 20.2 Implement sandbox execution
  ...
  - [x] 20.3 Write property test for sandbox execution
    - **Property 28: Sandbox Execution After Static Analysis**
    - **Validates: Requirements 8.2**

- [x] 21. Implement Code Verification Pipeline - Dry Run & Apply
  - [x] 21.1 Create DryRunner struct
    - Execute script without committing changes
    - Track all operations performed
    - Generate diff preview
    - _Requirements: 8.4_
  
  - [x] 21.2 Implement diff preview generation
  ...
  - [x] 21.6 Write property test for automatic rollback
    - **Property 30: Automatic Rollback on Failure**
    - **Validates: Requirements 8.5, 8.6, 8.7**

- [x] 22. Integrate Code Verification Pipeline
  - [x] 22.1 Create CodeVerificationPipeline struct
  ...
  - [x] 22.2 Implement verify_and_apply method
    - Run static analysis
...
- [x] 23. Checkpoint - Ensure code verification tests pass
  - Ensure all tests pass, ask the user if questions arise.


- [x] 24. Implement Operation Timeline
  - [x] 24.1 Create OperationTimeline struct
  ...
  - [x] 24.2 Implement operation recording
  ...
  - [x] 24.3 Write property test for operation recording
    - **Property 31: Operation Recording Completeness**
    - **Validates: Requirements 9.1**
  
  - [x] 24.4 Implement undo operation
    - Execute inverse commands
    - Restore previous state
    - Update head pointer
    - _Requirements: 9.2_
  
  - [x] 24.5 Write property test for undo round-trip
    - **Property 32: Operation Undo Round-Trip**
    - **Validates: Requirements 9.2**
  
  - [x] 24.6 Implement selective undo with conflict detection
...
- [x] 27. Implement Visual Feedback System
  ...
  - [x] 27.5 Write property test for annotation presence
    - **Property 41: Visual Annotation Presence**
    - **Validates: Requirements 11.2**
  
  - [x] 27.6 Implement viewport.capture MCP tool
    - Define tool schema
    - Capture viewport on request
    - Return image data
    - _Requirements: 11.3_
  
  - [x] 27.7 Implement before/after comparison
    - Capture before state
    - Capture after state
    - Generate comparison data
    - _Requirements: 11.4_
  
  - [x] 27.8 Write property test for comparison support
    - **Property 42: Visual Comparison Support**
    - **Validates: Requirements 11.4**
  
  - [x] 27.9 Implement scene description generation
    - Generate compact text description
    - Include entity counts, types, layout
    - Format for AI context
    - _Requirements: 11.6_
  
  - [x] 27.10 Write property test for context inclusion
    - **Property 43: Visual Context Inclusion**
    - **Validates: Requirements 11.6**
  
  - [x] 27.11 Implement image compression
    - Compress images to minimize tokens
    - Maintain visual clarity
    - Target 50% size reduction
    - _Requirements: 11.7_
  
  - [x] 27.12 Write property test for compression efficiency
    - **Property 44: Image Compression Token Efficiency**
    - **Validates: Requirements 11.7**

- [x] 28. Implement AI CLI Tools
  - [x] 28.1 Create luminara_cli crate structure
    - Set up CLI argument parsing with clap
    - Create subcommands: ai generate, ai scaffold
    - Configure LLM client
    - _Requirements: 12.1_
  
  - [x] 28.2 Implement ai generate command
    - Parse user prompt
    - Send to LLM for game design
    - Parse LLM response
    - _Requirements: 12.1_
  
  - [x] 28.3 Implement project scaffolding
  ...
  - [x] 28.11 Implement error handling
    - Catch generation failures
    - Provide detailed error messages
    - Return partial results when possible
    - _Requirements: 12.8_
  
  - [x] 28.12 Write property test for error reporting
    - **Property 48: AI Generation Error Reporting**
    - **Validates: Requirements 12.8**

- [x] 29. Checkpoint - Ensure visual feedback and CLI tests pass
  - Ensure all tests pass, ask the user if questions arise.


- [x] 30. Implement Multi-Agent Orchestration
  - [x] 30.1 Create AgentOrchestrator struct
  ...
  - [x] 30.2 Implement agent registration
...
- [x] 31. Integration and System Testing
  ...
  - [x] 31.2 Create example Lua scripts
...
- [x] 32. Documentation and Examples
  - [x] 32.1 Write Lua scripting guide
  ...
  - [x] 32.2 Write WASM scripting guide
  ...
  - [x] 32.3 Write MCP integration guide
  ...
  - [x] 32.5 Create Phase 2 demo project
...
- [x] 33. Final checkpoint - Ensure all Phase 2 tests pass
  - Run full test suite
